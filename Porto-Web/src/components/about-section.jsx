      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-16">
        ...
        <div className="md:col-span-2">
          <p className="text-gray-300 text-2xl leading-relaxed mb-10 animate-on-scroll delay-100">
            ...
            well as an IT staff, who has a deep interest in Cloud Engineering and Cyber Security. I am ready to work and
            be a source of joy and inspiration in every task I take on.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mt-16">
            <div className="card-dark p-10 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 animate-on-scroll delay-200">
              ...
              <p className="text-gray-300 text-xl text-justify">
                To become a skilled Cloud Engineer who can design, implement, and manage cyber-attack-safe cloud
